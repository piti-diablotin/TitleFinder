...
/**
 * WARNING
 * This class is only here for convinience and should not be used or copied anywhere else.
 * When https://itrack.barco.com/browse/BAT0007-111 is resolved one can remove this class and use the BTB CmdLine class instead
 */
...
class Parser {
 ...
 public:
   ...
   */
  template <class T>
  T getOption(const std::string_view option) {
...
template <>
bool Parser::getOption(std::string_view option);

template <>
std::string Parser::getOption(std::string_view option);
